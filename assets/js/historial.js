// Llamar a la función mostrarInformacion al cargar la página
...
function mostrarInformacion() {
  // Actualizar cantidad de atenciones
  ...
  // Actualizar información de la primera y última atención
  document.getElementById(
    "atencion-radiologia"
  ).textContent = `Primera atención: ${radiologia[0].paciente} - ${
  ...
  ).textContent = `Primera atención: ${traumatologia[0].paciente} - ${
  ...
  document.getElementById("atencion-dental").textContent = `Primera atención: ${
    dental[0].paciente
  } - ${dental[0].prevision} | Última atención: ${
    dental[dental.length - 1].paciente
  } - ${dental[dental.length - 1].prevision}.`; // Asegúrate de que 'prevision' esté correctamente escrito en tus objetos
}
